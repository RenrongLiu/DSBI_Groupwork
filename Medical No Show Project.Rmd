...
```
```{r}
logit_sel_best_model<-glm(No_show~Time_gap+Age+SMS_received+Sche_hour,
                      family="binomial",data=train)
...
```{r}
rbind(ct_correct,xgb_sel_correct,xgb_sel_correct,logit_sel_correct,logit_correct,svm_correct,svm_sel_correct,rf_correct,rf_sel_correct)->accuracy
accuracy
```
